    ...
    const loadStorefront = async () => {
      ...
      try {
        ...
        console.log('📋 Storefront data loaded:', {
          ...
          moduleCount: data.customization?.modules?.length || 0,
          modules: data.customization?.modules?.map((m) => ({
            type: m.type,
                  ...
                  {expandedFooterModule && (
                    ...
                    >
                      {expandedFooterModules
                        ...
                        .map((item: FooterModuleItem, index: number) => {
                            ...
                            const renderReturnsWarranty = () => (
                              <Box>
                                ...
                                <Typography
                                  ...
                                  sx={{ mb: 2, color: '#6B7280' }}
                                >
                                  Comprehensive warranty and return policies for
                                  your protection.
                                </Typography>
                                <Box
                                  sx={{
